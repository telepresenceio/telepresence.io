...
## Version 2.21.0
## <div style="display:flex;"><img src="images/feature.png" alt="feature" style="width:30px;height:fit-content;"/><div style="display:flex;margin-left:7px;">[Automatic subnet conflict avoidance](reference/vpn)</div></div>
...
## <div style="display:flex;"><img src="images/feature.png" alt="feature" style="width:30px;height:fit-content;"/><div style="display:flex;margin-left:7px;">[Add deployments, statefulSets, replicaSets to workloads Helm chart value](reference/intecepts/sidecar#disable-workloads)</div></div>
<div style="margin-left: 15px">
