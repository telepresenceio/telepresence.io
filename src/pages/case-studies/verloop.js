		...
		<EasyLayout title="Verloop Case Study" location={location}>
			{/* <section id="case-study" className="bg-white">
				<div className="container">
					<h1 className="title">
						Verloop: Going from 4.5 minute to 0 second build times
					</h1>
					...
					<p>
						...
						conversational marketing platform, which is a fancy way of saying
						that we are a SaaS platform to run livechat with chatbots as a first
						class citizen.
					</p>
					...
					<p>
						...
						variables separately with shell scripts. We didn’t need to forward
						the filesystem, so we never did that. Maintaining environment
						variables was a pain. Forwarding traffic from local to the pod was
						also a pain, requiring a lot of set up and configuration.
					</p>
					...
					<p>
						We were going to roll our own internal software to do pretty much
						what Telepresence does. We asked for similar solutions on the
						Kubernetes Slack channel and looked up on Google. I landed on your
						website and knew this was exactly what I wanted.
					</p>
					...
					<div className="text-center">
						<a href="/docs/latest/quick-start/" className="btn btn-black">
							Get Started
						</a>
					</div>
				</div>
			</section> */}
			<CaseStudyTemplate caseStudy="Verloop">
				<h2>
