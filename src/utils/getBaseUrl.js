...
const PROD_DOCS_DOMAIN = {
  'www.getambassador.io': API_URL,
  'archive.getambassador.io': API_URL,
};
const PROD_DOCS_DOMAIN_UI = {
  'www.getambassador.io': UI_URL,
  'archive.getambassador.io': UI_URL,
};
